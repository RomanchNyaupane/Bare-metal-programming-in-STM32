...
//following data stream. If data stream follows a command, datasize parameter in I2C_transfer() does not matter in initialization
//but it is important in for loop used to write data in tx register
void I2C_transfer_data (I2C_Config_t *i2cConfig, uint8_t *data, uint8_t dataSize)
{
